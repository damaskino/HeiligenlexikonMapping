...
from src.occupation_extraction import setup_occupation_list, extract_occupation
...
for entry_id, paragraph_from_mapping in tqdm(entry_paragraph_mapping):
    ...
    occupation = extract_occupation(paragraph_from_mapping, occupation_list=occupation_list)
    if occupation == None:
        occupation = " "
