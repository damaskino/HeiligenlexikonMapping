...
from src.regex_matching import match_raw_feast_day
...
for _, paragraph_from_mapping in tqdm(entry_paragraph_mapping):
    ...
    if raw_feast_date is not None:
        result_string += raw_feast_date
        result_string += "\n"

print("writing to file")
with open("../../data/1_intermediate/first_paragraphs_raw_feast_days_only.txt", "w", encoding="utf-8") as entries_file:
